...
GitlabMCPSharp is licensed under the MIT License (see `LICENSE`). It depends on
...
"GitLab" is a trademark of GitLab B.V. Use of the name in this project does not
imply endorsement by, or affiliation with, GitLab.
