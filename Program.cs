    ...
    public static int Main(string[] args)
    {
        ...
        try
        {
            ...
            builder.Configuration
                ...
                .AddJsonFile(ResolveConfigFile(contentRoot, "GitlabMCPSharp.json"), optional: true, reloadOnChange: true)
                .AddJsonFile(ResolveConfigFile(contentRoot, $"GitlabMCPSharp.{builder.Environment.EnvironmentName}.json"), optional: true, reloadOnChange: true)
                .AddJsonFile(ResolveConfigFile(contentRoot, "GitlabMCPSharp.Local.json"), optional: true, reloadOnChange: true)
